...
describe('composeSetupUri', function () {
    test('get Setup Uri for category, password', function () {
        expect.assertions(1);
        expect((0, qrcode_utils_1.composeSetupUri)({ categoryId: categories_1.CATEGORIES.switch, flag: 2, password: '84131633', setupId: '' })).toBe('X-HM://0081YCYEP');
    });
    test('get Setup Uri for category, password and setupId', function () {
        expect.assertions(1);
        expect((0, qrcode_utils_1.composeSetupUri)({ categoryId: categories_1.CATEGORIES.switch, flag: 2, password: '84131633', setupId: '3QYT' })).toBe('X-HM://0081YCYEP3QYT');
    });
    test('get Setup Uri for category, flag, password and setupId', function () {
        expect.assertions(1);
        expect((0, qrcode_utils_1.composeSetupUri)({ categoryId: categories_1.CATEGORIES.switch, flag: 4, password: '84131633', setupId: '3QYT' })).toBe('X-HM://0086E6GJ53QYT');
    });
});
    ...
    test('get QR code for ble switch', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    expect.assertions(1);
                    setupUri = (0, qrcode_utils_1.composeSetupUri)({ categoryId: categories_1.CATEGORIES.switch, flag: 4, password: '84131633', setupId: '3QYT' });
                    return [4 /*yield*/, (0, qrcode_utils_1.composeQrCode)({ pairingCode: '84131633', setupUri: setupUri })];
                case 1:
                    qrCode = _a.sent();
