...
var composeSetupUri = function (_a) {
    var categoryId = _a.categoryId, flag = _a.flag, password = _a.password, _b = _a.reserved, reserved = _b === void 0 ? 0 : _b, setupId = _a.setupId, _c = _a.version, version = _c === void 0 ? 0 : _c;
    var payload = 0;
    ...
    var payloadBase36 = payload.toString(36).toUpperCase().padStart(9, '0');
    return "X-HM://".concat(payloadBase36).concat(setupId);
};
exports.composeSetupUri = composeSetupUri;
